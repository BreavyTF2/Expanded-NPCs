...
if (IsMounted( "hl1" ) ) then
local NPC = { Name = "Archer", Class = "monster_generic", Model = "models/archer.mdl", Category = Category} list.Set( "NPC", "monster_archer", NPC )local NPC = { Name = "Big Rat", Class = "monster_generic", Model = "models/bigrat.mdl", Category = Category} list.Set( "NPC", "monster_rat", NPC )
