-- More NPCs LUA file, by Ry13y04 and Yosh
...
--AddNPC( { Name = "Ground Turret", Class = "npc_turret_ground", KeyValues = { SquadName = "overwatch" }, Category = Category} )

local Category = "Half-Life: Source" 
if ( IsMounted( "hl1" ) ) then
	AddNPC( { Name = "Apache", Class = "monster_apache", Offset = 200, Category = Category} )
	...
	AddNPC( { Name = "Floater", Class = "monster_bloater", Category = Category} )
	AddNPC( { Name = "Flyer", Class = "monster_flyer", Category = Category} )
...
--AddNPC( { Name = "SENT Nextbot", Class = "sent_nextbot", Category = Category} )
