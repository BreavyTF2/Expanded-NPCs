-- More NPCs Additional LUA file, by Ry13y04 and Yosh

-- For NPCs that cannot be put into the base lua "MoreNPCs.lua". These usually consist of custom model NPCs, flags, keyvalues, etc..
	-- This is because they could conflict with the already existing NPCs (for example 'Helicopter Boss' replacing the normal 'Helicopter' NPC.)
-- Also includes the actor NPCs ('generic_actor', 'monster_generic', 'cycler' and 'cycler_actor'. Furniture NPCs also allowed 'npc_furniture' and 'monster_furniture')

local Category = "Animals" 
	local NPC = { Name = "Leak Rat", Class = "cycler_actor", Model = "models/rat.mdl", Category = Category	} list.Set( "NPC", "LeakRat", NPC ) 
...
local Category = "Combine"
	...
	local NPC = { Name = "Mini Strider", Class = "generic_actor", Model = "models/ministrider.mdl", Category  = Category	} list.Set( "NPC", "MiniStrider", NPC )
